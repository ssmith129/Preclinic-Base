    ...
    <div class="content">
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text bg-transparent text-dark fs-14 border"
                    >F</span
                  >
                </div>
              </div>
      ...
      <div class="card rounded-0">
        ...
        <div class="card-body">
          <div class="complaint-list">
            <!-- Items -->
            <div
              class="mb-3 complaint-list-item"
              v-for="(complaint, index) in complaint"
              :key="index"
            >
        ...
        <div class="card-body pb-0">
          <div class="">
            <div class="diagnosis-list">
              ...
              <div
                class="row diagnosis-list-item"
                v-for="(diagnosis, index) in diagnosis"
                :key="index"
              >
                <div class="col-lg-6">
                  <div class="mb-3">
      ...
      <div class="card rounded-0">
        ...
        <div class="card-body pb-0">
          <div class="medication-list">
            <!-- start row -->
            <div
              class="row medication-list-item"
                  ...
                  <div class="col-lg-2">
                    <div class="mb-3">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" />
                        <span
                          class="input-group-text bg-transparent text-dark fs-14 border"
                          >mg</span
                        >
                      </div>
                    </div>
      ...
      <div class="card rounded-0">
        ...
        <div class="card-body advices-list pb-0">
          <div
            class="mb-3 advices-list-item"
            v-for="(advice, index) in advice"
            :key="index"
          >
            ...
            <div class="input-group">
              ...
              <a
                ...
                class="remove-advices ms-3 p-2 bg-light text-danger rounded d-flex align-items-center justify-content-center"
                ><i class="ti ti-trash fs-16"></i
              ></a>
            </div>
          </div>
      ...
      <div class="card rounded-0">
        ...
        <div class="card-body invest-list pb-0">
          <div
            class="mb-3 advices-list-item"
            v-for="(procedure, index) in procedure"
            :key="index"
          >
            <label class="form-label mb-1 text-dark fs-14 fw-medium"
