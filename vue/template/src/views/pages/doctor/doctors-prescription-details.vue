<template>
          ...
          <div class="d-flex align-items-sm-center flex-sm-row flex-column mb-4">
            <div class="flex-grow-1">
              <h6 class="fw-bold mb-0 d-flex align-items-center">
                <router-link to="/doctor/doctors-prescriptions" class="me-1"
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="text-lg-end">
                  ...
                  <p class="text-dark mb-1">
                    Prescribed on : : <span class="text-body"> Cardiology OP</span>
                  </p>
                  <p class="text-dark mb-0">
                    Consultation : : <span class="text-body"> Cardiology OP</span>
                  </p>
                </div>
              </div>
              ...
              <!-- Items -->
              <div class="mb-4">
                <h6 class="mb-3 fs-16 fw-semibold text-center">
  ...
  <div class="p-3 bg-white border-1 border-top text-center">
    <p class="text-dark text-center">
      2025 © <span class="text-info">Preclinic </span> , All Rights Reserved
    </p>
  </div>
  <!-- End Footer-->
</template>
