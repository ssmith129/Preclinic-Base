      ...
      <div class="row">
        <div class="col-xl-4">
          <div class="card">
            ...
            <!-- end card header -->
            <div class="card-body">
              <button type="button" class="btn btn-primary btn-wave" id="liveToastBtn">
                Show live toast
              </button>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div
                class="toast align-items-center text-bg-primary border-0 fade show mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
              ...
              <div
                class="toast align-items-center text-bg-secondary border-0 fade show mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
              ...
              <div
                class="toast align-items-center text-bg-success border-0 fade show mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="toast-container position-fixed top-0 end-0 p-3">
                <div
                  id="primaryToast"
                  class="toast colored-toast bg-primary-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
                ...
                <div
                  id="secondaryToast"
                  class="toast colored-toast bg-secondary-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
                ...
                <div
                  id="warningToast"
                  class="toast colored-toast bg-warning-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
                ...
                <div
                  id="infoToast"
                  class="toast colored-toast bg-info-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
                ...
                <div
                  id="successToast"
                  class="toast colored-toast bg-success-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
                ...
                <div
                  id="dangerToast"
                  class="toast colored-toast bg-danger-subtle"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="toast-container position-fixed top-0 start-0 p-3">
                <div
                  id="topleft-Toast"
                  class="toast colored-toast bg-primary-subtle text-primary"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                >
          ...
          <div class="card">
            ...
            <div class="card-body p-1">
              <div class="bd-example bd-example-toasts d-flex p-3">
                ...
                >
                  <div
                    class="toast fade show shadow-lg"
                    role="alert"
                    aria-live="assertive"
                    aria-atomic="true"
                  >
