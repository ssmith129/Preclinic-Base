    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Border Table</h5>
            </div>
            <div class="card-body">
              <div class="table-responsive">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap table-nowrap mb-0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Firstname</th>
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-borderless">
                  <thead>
                    <tr>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-striped">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-striped-columns">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                      <th scope="col">Date</th>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-sm">
                  <thead>
                    <tr>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap">
                ...
                <table class="table table-nowrap text-nowrap table-hover">
                  ...
                  <tbody>
                          ...
                          <div>
                            ...
                            <div class="lh-1">
                              <span class="fs-11 text-muted"
                                >joannasmith14@example.com</span
                              >
                            </div>
                          </div>
                        </div>
                    ...
                    <tr>
                      ...
                      <td><span class="badge bg-dark">Electronics</span></td>
                      <td>
                        <div class="avatar-list-stacked">
                          <span class="avatar avatar-sm avatar-rounded">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-striped table-hover">
                  <thead>
                    <tr>
                      <th scope="col">Invoice</th>
                      <th scope="col">Customer</th>
                ...
                <table class="table table-nowrap text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Manufacturer</td>
                      <td><span class="badge bg-primary">Team Lead</span></td>
                    ...
                    <tr>
                      ...
                      <td>Recruiter</td>
                      <td><span class="badge bg-danger">Employee</span></td>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-nowrap text-nowrap table-primary mb-0">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="table-primary">
                    <tr>
                      <th>#</th>
                      <th class="w-25">table-primary</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="table-secondary">
                    <tr>
                      <th>#</th>
                      <th class="w-25">table-secondary</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="table-success">
                    <tr>
                      <th>#</th>
                      <th class="w-25">table-success</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="table-warning">
                    <tr>
                      <th>#</th>
                      <th class="w-25">table-warning</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table">
                  <thead class="bg-primary bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-primary.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
                ...
                <table class="table">
                  <thead class="bg-secondary bg-gradient">
                    <tr>
                      ...
                      <th class="w-25 text-white">.bg-secondary.bg-gradient</th>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="bg-success bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-success.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="bg-warning bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-warning.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="bg-info bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-info.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead class="bg-danger bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-danger.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table table-nowrap">
                  <thead class="bg-dark bg-gradient text-white">
                    <tr>
                      <th class="text-white">#</th>
                      <th class="w-25 text-white">.bg-dark.bg-gradient</th>
                      <th class="text-white">Last Name</th>
                      <th class="text-white">Username</th>
                      <th class="text-white">Role</th>
                    </tr>
              ...
              <div class="table-responsive">
                <table class="table table-nowrap mb-0">
                  <thead class="bg-light bg-gradient">
                    <tr>
                      <th>#</th>
                      <th class="w-25">.bg-light.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
