    ...
    <div class="content">
      ...
      <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
        <div class="flex-grow-1">
          <h4 class="fs-18 fw-semibold mb-0">Checks & Radios</h4>
        </div>
        <div class="text-end">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>&lt;div&gt;</code> to create our custom control. Structurally, this
                is the same approach as our default <code>.form-check</code>.
              </p>
              <div class="mt-3">
              ...
              <div class="form-check form-checkbox-secondary mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customCheckcolor6"
              ...
              <div class="form-check form-checkbox-dark">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customCheckcolor7"
                  >Dark Checkbox</label
                >
              </div>
            ...
            <div class="card-body">
              ...
              <div class="form-check mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customRadiocolor1"
                  >Default Radio</label
                >
              </div>
              <div class="form-check form-radio-success mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customRadiocolor2"
                  >Success Radio</label
                >
              </div>
              ...
              <div class="form-check form-radio-secondary mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customRadiocolor6"
                  >Secondary Radio</label
                >
              </div>
              <div class="form-check form-radio-warning mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customRadiocolor4"
                  >Warning Radio</label
                >
              </div>
              <div class="form-check form-radio-danger mb-2">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="customRadiocolor5"
                  >Danger Radio</label
                >
              </div>
