<template>
  <div class="col-lg-4 col-md-6">
    <div
      class="bg-white d-flex align-items-center justify-content-between border p-2 rounded mb-3"
    >
        ...
        <div class="ms-2">
          ...
          <div class="d-flex align-items-center">
            ...
            <p class="fs-12 mb-0 d-flex align-items-center">
              <i class="ti ti-circle-filled fs-6 me-2 text-dark"></i>135 files
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ms-2">
          ...
          <div class="d-flex align-items-center">
            ...
            <p class="fs-12 mb-0 d-flex align-items-center">
              <i class="ti ti-circle-filled fs-6 me-2 text-dark"></i>15 files
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ms-2">
          ...
          <div class="d-flex align-items-center">
            ...
            <p class="fs-12 mb-0 d-flex align-items-center">
              <i class="ti ti-circle-filled fs-6 me-2 text-dark"></i>115 files
            </p>
          </div>
        </div>
      </div>
