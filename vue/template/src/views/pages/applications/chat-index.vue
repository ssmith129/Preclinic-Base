              ...
              <div class="chat-user-nav">
                <div>
                  ...
                  <div>
                    ...
                    <div class="chat-users p-4 slimscroll" data-simplebar>
                      ...
                      >
                        ...
                        <div class="text-end">
                          ...
                          <span
                            class="badge ms-auto bg-danger rounded-circle message-count"
                            >5</span
                          >
                        </div>
                      </div>
                      ...
                      >
                        <div class="d-flex align-items-center">
                          <a
                            href="#"
                            class="avatar badge-soft-purple fw-semibold me-2 flex-shrink-0"
                            >TD</a
                          >
                          <div>
                      ...
                      >
                        ...
                        <div class="text-end">
                          ...
                          <span class="d-block text-light"
                            ><i class="ti ti-checks text-light"></i
                          ></span>
                        </div>
                      </div>
                      <div
                ...
                <div class="card border-0 mb-0">
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p class="mb-0 d-inline-flex align-items-center">
                          <i class="ti ti-point-filled text-success"></i>Online
                        </p>
                      </div>
                    </div>
                    <div class="gap-2 d-flex align-items-center flex-wrap">
                      ...
                      <a
                        href="javascript:void(0);"
                        class="btn btn-icon btn-light close-chat d-md-none"
                        ><i class="ti ti-x"></i
                      ></a>
                    </div>
                  </div>
                  ...
                  <div class="card-body p-0">
                    <div class="message-body p-4 slimscroll">
                      <div class="chat-list mb-3">
                        <div class="d-flex align-items-start">
                          <span class="avatar online me-2 flex-shrink-0"
                            ><img src="@/assets/img/users/user-10.jpg" alt="user"
                          /></span>
                          <div>
                            <div class="d-flex align-items-center mb-1">
                              ...
                              <p class="mb-0 d-inline-flex align-items-center">
                                <i class="ti ti-point-filled mx-2"></i>02:39 PM
                              </p>
                            </div>
                            <div class="d-flex align-items-center">
                                ...
                                <ul class="dropdown-menu p-2">
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-heart me-1"></i>Reply</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-pinned me-1"></i>Forward</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-file-export me-1"></i>Copy</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-heart me-1"></i>Mark as
                                      Favourite</a
                                    >
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-check me-1"></i>Mark as Unread</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-box-align-right me-1"></i>Archeive
                                      Chat</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="ti ti-pinned me-1"></i>Pin Chat</a
                                    >
                                  </li>
                                </ul>
                              </div>
                      ...
                      <div class="chat-list ms-auto mb-3">
                        <div class="d-flex align-items-start justify-content-end">
                          <div>
                            ...
                            >
                              <p class="mb-0 d-inline-flex align-items-center">
                                <i class="ti ti-checks text-success me-1"></i>02:39 PM<i
                                  class="ti ti-point-filled mx-2"
                                ></i>
                              </p>
                          ...
                          <span class="avatar ms-2 online flex-shrink-0"
                            ...
                            <div class="d-flex align-items-center">
                              <div class="message-box receive-message p-3">
                                ...
                                <div class="d-flex align-items-center gap-2 d-none">
                                  <span class="bg-white d-block rounded p-1"
                                    ><img
                      ...
                      <div class="text-center">
                        <span class="badge bg-light rounded-pill px-3 text-dark fs-14"
                          >Today</span
                        >
                      </div>
                      <div class="chat-list ms-auto mb-3">
                        <div class="d-flex align-items-start justify-content-end">
                          <div>
                            ...
                            >
                              <p class="mb-0 d-inline-flex align-items-center">
                                <i class="ti ti-checks text-success me-1"></i>10:00 AM<i
                                  class="ti ti-point-filled mx-2"
                                ></i>
                              </p>
                              <h6 class="fs-14 fw-semibold mb-0">You</h6>
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="message-box sent-message p-3">
                                <p class="mb-0 fs-16">
                                  Looks clean! I like the font. Maybe try a slightly
                                  darker blue?
                                </p>
                              </div>
                            </div>
                        ...
                        <div class="d-flex align-items-start">
                          ...
                          <div>
                            <div class="d-flex align-items-center mb-1">
                              <h6 class="fs-14 mb-0">Mark Smith</h6>
                              <p class="mb-0 d-inline-flex align-items-center">
                                <i class="ti ti-point-filled mx-2"></i>10:05 AM
                              </p>
                            </div>
                            <div class="d-flex align-items-center">
                              <div class="message-box receive-message p-3">
                                <p class="mb-0 fs-16">
                                  Perfect! That layout will work great on the landing
                                  page. 👍
                                </p>
                              </div>
                              <div class="ms-2">
