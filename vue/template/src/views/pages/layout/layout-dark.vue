  ...
  setup() {
    ...
    const layoutType = computed(() => {
      if (route.path === "/layouts/layout-dark") {
        return "dark"; // If path matches, set layout type to detached
      } else if (route.path === "/layouts/layout-dark") {
        return "dark"; // If path matches, set layout type to horizontal
      } else {
        return "dark"; // Default layout
      }
    });
    ...
    const updateLayoutAttribute = () => {
      ...
      document.documentElement.setAttribute("data-bs-theme", layoutType.value);
    };
    ...
    onBeforeUnmount(() => {
      document.documentElement.removeAttribute("data-bs-theme"); // Clean up when the component is destroyed
    });
