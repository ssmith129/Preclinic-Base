      ...
      <li class="menu-title"><span>Extras</span></li>
        <li>
            <ul>
                ...
                <li>
                    <a href="javascript:void(0);"><i class="ti ti-exchange"></i><span>Changelog</span><span class="badge bg-danger ms-2 badge-md rounded-2 fs-12 fw-medium">v1.7.0</span></a>
                </li>
                <li class="submenu">
