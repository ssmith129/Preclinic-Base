        ...
        <div className="content pb-0">
          ...
          <div className="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
            ...
            <div className="d-flex align-items-center flex-wrap gap-2">
              ...
              <Link
                href={all_routes.doctorschedule}
                  ...
                  <div className="row row-gap-3">
                    <div className="col-md-4">
                      <div className="border shadow-sm p-3 rounded-2">
                        ...
                        <p className="mb-0">
                          <span className="text-dark fw-semibold me-1">258</span>
                          Bookings
                        </p>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="border shadow-sm p-3 rounded-2">
                        ...
                        <p className="mb-0">
                          <span className="text-dark fw-semibold me-1">125</span>
                          Bookings
                        </p>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="border shadow-sm p-3 rounded-2">
                        ...
                        <p className="mb-0">
                          <span className="text-dark fw-semibold me-1">115</span>
                          Bookings
                        </p>
                      </div>
                    </div>
                ...
                <div className="card-body">
                  ...
                  <div className="overflow-auto">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div className="flex-shrink-0 ms-2">
                        <Link href="#" className="btn btn-primary btn-sm py-1">
                          Book Now
                        </Link>
                      </div>
                    </div>
