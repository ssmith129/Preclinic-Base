            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  >
                    <Link href="#" tabIndex={0} className="btn btn-danger">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  >
                    <Link href="#" tabIndex={0} className="btn btn-success">
                      Dismissible popover
                    </Link>
                  </OverlayTrigger>
                </div>
            ...
            <div className="col-xl-6">
              <div className="card card-h-100">
                ...
                <div className="card-body">
                  ...
                  >
                    <Link href="#" tabIndex={0} className="btn btn-dark">
                      Please Hover Me
                    </Link>
                  </OverlayTrigger>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    <OverlayTrigger
                      ...
                      overlay={popoverTop}
                    >
                      <Link href="#" tabIndex={0} className="btn btn-primary">
                        Popover on top
                      </Link>
                    </OverlayTrigger>
                    <OverlayTrigger
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    ...
                    >
                      <Link href="#" tabIndex={0} className="btn btn-info">
                      Info popover
                      </Link>
                    </OverlayTrigger>
                    <OverlayTrigger
                    ...
                    >
                      <Link href="#" tabIndex={0} className="btn btn-secondary">
                      Secondary popover
                      </Link>
                    </OverlayTrigger>
                  </div>
...
export default UiPopoversComponent;
