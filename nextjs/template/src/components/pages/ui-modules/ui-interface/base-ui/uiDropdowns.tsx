        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
            <div className="flex-grow-1">
              <h4 className="fs-18 fw-semibold mb-0">Dropdowns</h4>
            </div>
          ...
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="dropup-center dropup">
                    ...
                    <ul
                      className="dropdown-menu"
                      aria-labelledby="dropupCenterBtn"
                    >
                      <li>
                        <Link className="dropdown-item" href="#">
                          Action
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    To align <strong>right</strong> the dropdown menu with the
                    given breakpoint or larger, add
                    <code>
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    To align <strong>left</strong> the dropdown menu with the
                    given breakpoint or larger, add
          ...
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    ...
                    to work with either <code>&lt;button&gt;</code>
                    elements:
                  </p>
                  <div className="row">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Add a header to label sections of actions in any dropdown
                    menu.
                  </p>
                  {/* Header Item */}
                  <div className="btn-group">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    ...
                    use spacing utilities. Note that you’ll likely need
                    additional sizing styles to constrain the menu width.
                  </p>
                  {/* Text Example */}
                  <div className="btn-group">
                    <button
...
export default UiDropdownsComponent;
