...
const PatientNotificationsSettingsComponent = () => {
  return (
    <>
  {/* ========================
			Start Page Content
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="text-start">
                <Link
                  href={all_routes.patientprofilesettings}
                ...
                <Link
                  href={all_routes.patientpasswordsettings}
                  className="btn btn-md rounded fs-14 fw-medium text-dark mb-1 w-100 justify-content-start"
                >
                ...
                <Link
                  href={all_routes.patientnotificationssettings}
...
export default PatientNotificationsSettingsComponent