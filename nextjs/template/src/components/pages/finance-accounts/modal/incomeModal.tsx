...
const IncomeModalComponent = () => {
  ...
  return (
    <>
      {/* Start Add Income */}
      <div className="modal fade" id="add_new_income">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title text-dark fw-bold">New Income</h5>
              <button
                type="button"
      ...
      {/* End Add Income  */}
      {/* Start Edit Income */}
      <div className="modal fade" id="edit_new_income">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title text-dark fw-bold">Edit Income</h5>
              <button
                type="button"
                className="btn-close btn-close-modal custom-btn-close"
                data-bs-dismiss="modal"
