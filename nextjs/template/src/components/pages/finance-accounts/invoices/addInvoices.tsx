                        ...
                        <tbody className="invoices-list">
                          ...
                          <tr>
                            ...
                            <Link
                                ...
                                className="btn add-invoices border-0 text-dark d-felx align-items-center fs-14 justify-content-start"
                              >
...
export default AddInvoicesComponent;
