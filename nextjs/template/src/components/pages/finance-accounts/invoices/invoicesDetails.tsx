...
const InvoicesDetailsComponent = () => {
  return (
    <>
      {/* ========================
			Start Page Content
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                    <div className="invoice-logo">
                      <ImageWithBasePath src="assets/img/logo.svg" className="logo-white" alt="logo" />
                      <ImageWithBasePath src="assets/img/logo-white.svg" className="logo-dark" alt="logo" />
                    </div>
...
export default InvoicesDetailsComponent;
