          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3">
            <div className="flex-grow-1">
              <h6 className="fw-bold mb-0 d-flex align-items-center">
                <Link href={all_routes.invoices} className="">
          ...
          <div className="card">
                          ...
                          <tr>
                            <td>
                              <Link
                                ...
                                className="btn add-invoices border-0 text-dark d-flex align-items-center fs-14 justify-content-start"
                              >
            ...
            <div className="card-footer">
              <div className="d-flex gap-2 align-items-center justify-content-end mb-0">
                <Link
                  href="#"
                  className="btn btn-md btn-light text-dark fs-13 fw-medium rounded"
                >
                  {" "}
                  Cancel{" "}
                </Link>
...
export default EditInvoicesComponent;
