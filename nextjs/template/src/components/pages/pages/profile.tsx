              ...
              <div className="row border-bottom mb-3">
                  ...
                  <div className="row align-items-center mb-3">
                    ...
                    <div className="col-lg-6">
                      <div className="pass-group input-group">
                        ...
                        <input
                          type="password"
                          className="pass-input form-control rounded"
                        />
                      </div>
                    </div>
                    {/* end col */}
                ...
                <div className="col-lg-4">
                  ...
                  <div className="row align-items-center mb-3">
                    ...
                    <div className="col-lg-6">
                      <div className="pass-group input-group">
                        {/* <span className="isax toggle-passwords isax-eye-slash" /> */}
                        <input
                          type="password"
                          className="pass-inputs form-control rounded"
                        />
                      </div>
                    </div>
                    {/* end col */}
                ...
                <div className="col-lg-4">
                  ...
                  <div className="row align-items-center mb-3">
                    ...
                    <div className="col-lg-6">
                      <div className="pass-group input-group">
                        {/* <span className="isax toggle-passworda isax-eye-slash" /> */}
                        <input
                          type="password"
                          className="pass-inputa form-control rounded"
                        />
                      </div>
                    </div>
                    {/* end col */}
