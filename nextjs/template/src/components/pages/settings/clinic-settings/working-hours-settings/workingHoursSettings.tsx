...
import CommonTimePicker from "@/core/common/common-time-pickers/CommonTimePicker";

const WorkingHoursSettingsComponent = () => {
...
export default WorkingHoursSettingsComponent;
