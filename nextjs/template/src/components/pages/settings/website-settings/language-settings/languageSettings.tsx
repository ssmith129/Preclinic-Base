                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            <Link
                              href={all_routes.languagesettings2}
                            ...
                            <Link href={all_routes.languagesettings2}>English</Link>
                          </div>
                        </td>
                        <td>en</td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <Link href={all_routes.languagesettings2}>German</Link>
                          </div>
                        </td>
                        <td>de</td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <Link href={all_routes.languagesettings2}>Arabic</Link>
                          </div>
                        </td>
                        <td>ar</td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <Link href={all_routes.languagesettings2}>French</Link>
                          </div>
                        </td>
                        <td>fr</td>
                        <td>
