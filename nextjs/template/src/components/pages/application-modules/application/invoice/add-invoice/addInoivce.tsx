          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3">
            <div className="flex-grow-1">
              <h6 className="fw-bold mb-0 d-flex align-items-center">
                <Link href={all_routes.invoice} className="">
                          ...
                          <tr>
                            <td>
                              <Link
                                ...
                                className="btn add-invoices justify-content-start border-0 text-dark d-flex align-items-center fs-14"
                              >
...
export default AddInoivceComponent;
