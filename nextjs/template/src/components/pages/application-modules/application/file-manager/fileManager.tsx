          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
            ...
            <div className="text-end">
              <ol className="breadcrumb m-0 py-0">
                ...
                <li className="breadcrumb-item">
                  <Link href="javascript:void(0);">Applications</Link>
                </li>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    <div className="d-flex align-items-center overflow-hidden">
                      <span className="avatar avatar-md bg-warning-subtle">
                        <i className="ti ti-video fs-20 text-warning" />
                      </span>
                      <div className="overflow-hidden ms-2">
              ...
              <div className="border-bottom mb-3">
                <div className="d-flex align-items-center justify-content-between mb-2 table-header">
                  ...
                  <div className="dropdown mb-2">
                    <Link
                      href="javascript:void(0);"
                      className="dropdown-toggle btn btn-sm bg-white text-dark btn-outline-light drop-arrow-none"
                      data-bs-toggle="dropdown"
                    >
                      Last Modified
                      <i className="ti ti-chevron-down align-middle ms-1" />
                ...
                <div className="row">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="rounded border mb-3">
                      <div className="bg-transparent-dark p-5 d-flex align-items-center justify-content-center rounded-top">
                        <i className="ti ti-headphones fs-24 text-dark" />
                      </div>
                      <div className="bg-white d-flex align-items-center justify-content-between p-3 rounded-bottom">
                        <h6 className="fw-medium text-truncate mb-0">
                          <Link
              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                ...
                <div className="d-flex align-items-center">
                  <div className="dropdown me-2">
                    <Link
                      href="javascript:void(0);"
                      className="dropdown-toggle btn bg-white text-dark btn-sm btn-outline-light drop-arrow-none"
                      data-bs-toggle="dropdown"
                    >
                      Sort By : Docs Type
                      <i className="ti ti-chevron-down align-middle ms-1" />
        ...
        <div className="offcanvas-body p-0">
          <div className="bg-light p-3 text-center">
            ...
            <h6 className="mb-1">
              ...
              <span className="badge bg-secondary fw-normal fs-10 ms-2">
                2.4 GB
              </span>
            </h6>
            <p className="mb-0">Last Accessed on 15 Mar 2025, 08:15:23 PM</p>
          </div>
          <div className="p-3">
            <h6 className="mb-2">File Info</h6>
            <div className="border rounded d-flex align-items-center justify-content-between p-2 pb-0 gx-2 mb-3">
              <div className="text-center mb-2 border-end pe-2">
                <p className="fs-12 mb-0">File Type</p>
                <p className="text-dark mb-0">PDF</p>
              </div>
              <div className="text-center mb-2 border-end pe-2">
                <p className="fs-12 mb-0">Created on</p>
                <p className="text-dark table-nowrap mb-0">
                  22 Feb 2025, 08:30 PM
                </p>
              </div>
            ...
            <div className="card shadow-none">
              <div className="card-body p-3 pb-0">
                    ...
                    <div className="ms-2 flex-grow-1">
                      ...
                      <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                        <div className="d-flex align-items-center">
                          ...
                          <p className="ms-2 mb-0">All_files.mp4</p>
                        </div>
                    ...
                    <div className="ms-2 flex-grow-1">
                      ...
                      <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                        <div className="d-flex align-items-center">
                          ...
                          <p className="ms-2 mb-0">Screen.png</p>
                        </div>
                      ...
                      <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                        <div className="d-flex align-items-center">
                          ...
                          <p className="ms-2 mb-0">Finaldraft.zip</p>
                        </div>
                      ...
                      <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                        <div className="d-flex align-items-center">
                          <i className="ti ti-photo text-dark fs-16" />
                          <p className="ms-2 mb-0">Photo.jpg</p>
                        </div>
                ...
                <h6 className="mb-2">28 Jan 2025</h6>
                <ul className="recent-activity mb-3">
                  <li className="d-flex pb-2">
                    <span className="avatar avatar-md">
                      <ImageWithBasePath
                    ...
                    <div className="ms-2 flex-grow-1">
                      ...
                      <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                        <div className="d-flex align-items-center">
                          <i className="ti ti-photo text-dark fs-16" />
                          <p className="ms-2 mb-0">Photo_12.jpg</p>
                        </div>
            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              <Link
                href="javascript:void(0);"
                className="fs-12 link-primary mb-2"
                data-bs-toggle="modal"
              ...
              <div className="card-body p-3 pb-0">
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="fs-12 mb-0">Finance</p>
                    </div>
                  </div>
                  <Link href="javascript:void(0);" className="user-icon mb-2">
                ...
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="ms-2">
                      <h6 className="fw-medium mb-1">Harvey Smith</h6>
                      <p className="fs-12 mb-0">Developer</p>
                    </div>
                  </div>
                  <Link href="javascript:void(0);" className="user-icon mb-2">
                    <i className="ti ti-user-x fs-16" />
                ...
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="ms-2">
                      <h6 className="fw-medium mb-1">Stephan Peralt</h6>
                      <p className="fs-12 mb-0">Executive Officer</p>
                    </div>
                  </div>
                  <Link href="javascript:void(0);" className="user-icon mb-2">
                    <i className="ti ti-user-x fs-16" />
                ...
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="ms-2">
                      <h6 className="fw-medium mb-1">Doglas Martini</h6>
                      <p className="fs-12 mb-0">Manager</p>
                    </div>
                  </div>
                  <Link href="javascript:void(0);" className="user-icon mb-2">
                    <i className="ti ti-user-x fs-16" />
                ...
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="ms-2">
                      <h6 className="fw-medium mb-1">Linda Ray</h6>
                      <p className="fs-12 mb-0">Finance</p>
                    </div>
                  </div>
                  <Link href="javascript:void(0);" className="user-icon mb-2">
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              <span className="d-inline-flex align-items-center justify-content-center p-2 rounded-circle bg-danger mb-2">
                <i className="ti ti-trash fs-24 text-white" />
              </span>
              <h5 className="fw-medium mb-3">Are you sure to delete file?</h5>
              <div className="d-flex">
                <button
                  type="button"
                  className="btn btn-sm btn-light me-2 w-100"
                  data-bs-dismiss="modal"
                >
                  Cancel
                </button>
