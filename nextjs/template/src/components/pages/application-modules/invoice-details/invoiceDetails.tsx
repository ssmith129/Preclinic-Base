            ...
            <div className="flex-grow-1">
              <h6 className="fw-bold mb-0 d-flex align-items-center ">
                ...
                <Link href={all_routes.invoice}>
                  <i className="ti ti-chevron-left ms-1" />
                  Invoices
                </Link>
              </h6>
            </div>
              ...
              <div className="row pb-3 border-1 border-bottom mb-4">
                <div className="col-lg-4">
                  ...
                  <p className="text-body mb-1">
                    {" "}
                    Invoice Number : <span className="text-dark">
                      {" "}
                      INV0025
                    </span>{" "}
                  </p>
                  <p className="text-body mb-1">
                    {" "}
                    Issued On : <span className="text-dark">
                      {" "}
                      25 Jan 2025{" "}
                    </span>{" "}
                  </p>
                  <p className="text-body mb-1">
                    {" "}
                    Due Date : <span className="text-dark">
                      {" "}
                      31 Jan 2025
                    </span>{" "}
                  </p>
                ...
                <div className="col-lg-4">
                  ...
                  <p className="text-dark fw-medium mb-1"> Andrew Fletcher</p>
                ...
                <div className="col-lg-6">
                  <div className="">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      ...
                      <h6 className="fs-14 fw-semibold text-dark">$1,793.12</h6>
                    </div>
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <h6 className="fs-14 fw-medium text-body">CGST (9%)</h6>
                      <h6 className="fs-14 fw-semibold text-dark">$18</h6>
                    </div>
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <h6 className="fs-14 fw-medium text-body">SGST (9%)</h6>
                      <h6 className="fs-14 fw-semibold text-dark">$18</h6>
                    </div>
                    ...
                    <div>
                      <h6 className="fs-14 text-body mb-1">Total in words</h6>
