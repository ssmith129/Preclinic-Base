        ...
        <div className="content">
          ...
          <div className="d-flex align-items-center pb-3 mb-3 border-bottom">
            ...
            <div className="text-end">
              <Link href={all_routes.addBlogs} className="btn btn-primary">
              ...
              <div className="card blog-item">
                <div className="card-body p-0">
                  <div className="position-relative rounded-top overflow-hidden">
                    <Link href={all_routes.blogDetails} className="blog-img">
                      <ImageWithBasePath
                  ...
                  <div className="p-3">
                    ...
                    <h6 className="fw-bold">
                      <Link href={all_routes.blogDetails}>
