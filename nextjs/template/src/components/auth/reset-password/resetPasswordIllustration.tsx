...
const ResetPasswordIllustrationComponent = () => {
                      ...
                      <div className="d-flex flex-column justify-content-lg-center p-4 p-lg-0 pb-0 flex-fill">
                        ...
                        <div className="card border-1 p-lg-3 shadow-md rounded-3 mb-4">
                          <div className="card-body">
                            ...
                            <div className="mb-3">
                              <Link
                                href={all_routes.successIllustration}
                            ...
                            <div className="text-center">
                              <h6 className="fw-normal fs-14 text-dark mb-0">
                                Return to <Link href={all_routes.loginillustration} className="hover-a"> Login</Link>
                              </h6>
                            </div>
                          </div>
                          {/* end card body */}
...
export default ResetPasswordIllustrationComponent;
