                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-08.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-07.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-06.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-05.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-04.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-01.svg" alt="img" class="rounded-circle">
                                    </a>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                        <img src="assets/img/icons/clinic-03.svg" alt="img" class="rounded-circle">
                                    </a>
