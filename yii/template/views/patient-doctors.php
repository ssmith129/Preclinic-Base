                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Mick Thompson <span class="text-body fs-13 fw-normal d-block"> Cardiologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 54132 </td>
                            <td>
                            ...
                            <td class="">
                                <a href="patient-appointment-details" class="border p-1 rounded-3 fs-13 text-body d-inline-flex align-items-center justify-content-center">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Sarah Johnson<span class="text-body fs-13 fw-normal d-block"> Orthopedic Surgeon </span>  </a>
                                </div>
                            </td>
                            <td>+1 54554 54789</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Emily Carter <span class="text-body fs-13 fw-normal d-block"> Pediatrician </span>  </a>
                                </div>
                            </td>
                            <td>+1  43554 54985</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. David Lee<span class="text-body fs-13 fw-normal d-block"> Gynecologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 54124 </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Anna Kim <span class="text-body fs-13 fw-normal d-block"> Psychiatrist </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 23143 </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. John Smith<span class="text-body fs-13 fw-normal d-block"> Neurosurgeon </span>  </a>
                                </div>
                            </td>
                            <td>+1 51247 56574 </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Lisa White <span class="text-body fs-13 fw-normal d-block"> Oncologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 23423 54132 </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Patricia Brown <span class="text-body fs-13 fw-normal d-block"> Pulmonologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 51425 21498</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Rachel Green<span class="text-body fs-13 fw-normal d-block"> Urologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 45214 98741 </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patients-doctor-details" class="text-dark fw-semibold">Dr. Michael Smith <span class="text-body fs-13 fw-normal d-block"> Cardiologist </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 32540 </td>
                            <td>
