                                    ...
                                    <table class="table table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="assets/img/icons/signature-01.svg" alt="img" class="img-fluid"></td>
                                            ...
                                            <tr>
                                                <td>Michael Smith</td>
                                                <td><img src="assets/img/icons/signature-02.svg" alt="img" class="img-fluid"></td>
                                                <td><span class="badge bg-soft-success fs-13 fw-medium text-success border border-success py-1 px-2">Active</span></td>
                                                <td class="action-item">
                                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" class="btn p-1 btn-white border">
                                                        <i class="ti ti-dots-vertical"></i>
                                            ...
                                            <tr>
                                                <td>Alberto Alleo</td>
                                                <td><img src="assets/img/icons/signature-03.svg" alt="img" class="img-fluid"></td>
                                                <td><span class="badge bg-soft-success fs-13 fw-medium text-success border border-success py-1 px-2">Active</span></td>
                                                <td class="action-item">
                                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" class="btn p-1 btn-white border">
                                                        <i class="ti ti-dots-vertical"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets/img/icons/signature-04.svg" alt="img" class="img-fluid"></td>
