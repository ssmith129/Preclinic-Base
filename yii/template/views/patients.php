            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-1 border-bottom">
                ...
                <div class="text-end d-flex">
                    ...
                    <div class="bg-white border shadow-sm rounded px-1 pb-0 text-center d-flex align-items-center justify-content-center">
                        <a href="patients" class="bg-light rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-list fs-14 text-dark"></i></a>
                        <a href="patients-grid" class="bg-white rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-layout-grid fs-14 text-body"></i> </a>
                    </div>

                    <a href="create-patient" class="btn btn-primary ms-2 fs-13 btn-md"><i class="ti ti-plus me-1"></i>New Patient</a>
                </div>
            </div>
            <!-- End Page Header -->
                ...
                <table class="table datatable table-nowrap">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="patient-details" class="avatar avatar-md me-2">
                                        <img src="assets/img/users/user-08.jpg" alt="product" class="rounded-circle">
                                    </a>
                                    <a href="patient-details" class="text-dark fw-semibold">Alberto Ripley <span class="text-body fs-13 fw-normal d-block"> 26, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 54132</td>                                
                            <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-1">
                                    <a href="appointments" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1 me-1">
                                    ...
                                    <ul class="dropdown-menu p-2">
                                        <li>
                                            <a href="edit-patient" class="dropdown-item d-flex align-items-center">Edit</a>
                                        </li>
                                        <li>
                                            <a href="patient-details" class="dropdown-item d-flex align-items-center">View</a>
                                        </li>
                                        <li>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Susan Babin <span class="text-body fs-13 fw-normal d-block"> 21, Female </span>  </a>
                                </div>
                            </td>
                            <td>+1 54554 54789</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Carol Lam <span class="text-body fs-13 fw-normal d-block"> 28, Female </span>  </a>
                                </div>
                            </td>
                            <td>+1  43554 54985</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Marsha Noland <span class="text-body fs-13 fw-normal d-block"> 25, Female </span>  </a>
                                </div>
                            </td>
                            <td>+1 47554 54257</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Irma Armstrong <span class="text-body fs-13 fw-normal d-block"> 32, Female </span>  </a>
                                </div>
                            </td>
                            <td>+1 54114 57526</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Jesus Adams <span class="text-body fs-13 fw-normal d-block"> 27, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 51247 56574</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Ezra Belcher <span class="text-body fs-13 fw-normal d-block"> 28, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 41452 25741</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Glen Lentz <span class="text-body fs-13 fw-normal d-block"> 22, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 51425 21498</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Bernard Griffith <span class="text-body fs-13 fw-normal d-block"> 34, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 45214 98741</td>                                
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">John Elsass <span class="text-body fs-13 fw-normal d-block"> 23, Male </span>  </a>
                                </div>
                            </td>
                            <td>+1 41245 32540</td>                                
                            <td>
