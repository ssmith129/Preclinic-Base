            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="login-backgrounds d-lg-flex align-items-center justify-content-center d-none flex-wrap p-4 position-relative h-100 z-0">
                        <img src="assets/img/auth/reg-illustration-img.png" alt="log-illustration-img-01" class="img-fluid img1">
                    </div>
                </div> <!-- end row-->
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 position-relative">
                    <div class="row justify-content-center align-items-center overflow-auto flex-wrap vh-100 py-3">
                        <div class="col-md-8 mx-auto">
                            <form action="login-illustration" class="d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-check form-check-md mb-0">
                                                        ...
                                                        <label for="remember_me" class="form-check-label mt-0 text-dark">I agree to the <a href="terms-and-conditions" class="text-decoration-underline text-primary"> Terms of Service</a> & <a href="privacy-policy" class="text-decoration-underline text-primary">Privacy Policy </a></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div class="text-center">
                                                <h6 class="fw-normal fs-14 text-dark mb-0">Already have an account yet? 
                                                    <a href="login-illustration" class="hover-a"> Login</a>
                                                </h6>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
