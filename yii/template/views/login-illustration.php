            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="login-backgrounds d-lg-flex align-items-center justify-content-center d-none flex-wrap p-4 position-relative h-100 z-0">
                        <img src="assets/img/icons/log-illustration-img-01.png" alt="log-illustration-img-01" class="img-fluid img1">
                    </div>
                </div> <!-- end row-->
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row justify-content-center align-items-center overflow-auto flex-wrap vh-100 py-3">
                        <div class="col-md-8 mx-auto">
                            <form action="index" class="d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="card border-1 p-lg-3 shadow-md rounded-3 mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                ...
                                                <div class="text-end">
                                                    <a href="forgot-password-illustration" class="text-danger">Forgot Password?</a>
                                                </div>
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div class="text-center">
                                                <h6 class="fw-normal fs-14 text-dark mb-0">Don’t have an account yet?
                                                    <a href="register-illustration" class="hover-a"> Register</a>
                                                </h6>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
