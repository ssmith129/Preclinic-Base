                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-03.jpg" alt="Img"></a>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="assets/img/social/social-feed-01.jpg" class="rounded img-fluid" alt="Img">
                                </div>
                                <div class="row g-2 mb-2">
                                    <div class="col-md-3">
                                        <div class="img-full-view">
                                            <a href="assets/img/social/gallery-big-01.jpg" data-fancybox="gallery" class="gallery-item">
                                                <img src="assets/img/social/gallery-01.jpg" class="rounded img-fluid" alt="img">
                                    ...
                                    <div class="col-md-3">
                                        <div class="img-full-view">
                                            <a href="assets/img/social/gallery-big-03.jpg" data-fancybox="gallery" class="gallery-item">
                                                <img src="assets/img/social/gallery-03.jpg" class="rounded img-fluid" alt="img">
                                                <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="img-full-view">
                                            <a href="assets/img/social/gallery-big-02.jpg" data-fancybox="gallery" class="gallery-item">
                                                <img src="assets/img/social/gallery-02.jpg" class="rounded img-fluid" alt="img">
                                                <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="img-full-view">
                                            <a href="assets/img/social/gallery-big-04.jpg" data-fancybox="gallery" class="gallery-item">
                                                <img src="assets/img/social/gallery-04.jpg" class="rounded img-fluid" alt="img">
                                                <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-start">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="assets/img/profiles/avatar-04.jpg" alt="Img"></a>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-05.jpg" alt="Img"></a>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card shadow-none mb-3">
                                    <div class="card-img card-img-hover rounded-0">
                                        <a href="javascript:void(0);" class="rounded-top"><img src="assets/img/social/social-feed-02.jpg" class="rounded-top img-fluid" alt="Img"></a>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-04.jpg" alt="Img"></span>
                                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="assets/img/social/social-feed-03.jpg" class="rounded img-fluid" alt="Img">
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3">
                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3">
                                ...
                                <div class="d-flex align-items-start">
                                    <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="assets/img/profiles/avatar-05.jpg" alt="Img"></span>
                                    <input type="text" class="form-control" placeholder="Enter Comments">
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-img card-img-hover mb-3">
                                <a href="javascript:void(0);" class="rounded"><img src="assets/img/social/social-feed-04.jpg" class="rounded img-fluid w-100" alt="Img"></a>
                            </div>
