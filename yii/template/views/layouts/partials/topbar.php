...
<header class="navbar-header">
    <div class="page-container topbar-menu">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="new-appointment" class="btn topbar-link"><i class="ti ti-calendar-due"></i></a>
                </div>
            </div>                    
            <!-- Appointment -->
            ...
            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="profile-settings" class="btn topbar-link"><i class="ti ti-settings-2"></i></a>
                </div> 
            </div> 
            <!-- Settings -->                   

            <?php if ($page !=='layout-dark' && $page !=='layout-mini' && $page !=='layout-hidden' && $page !=='layout-hover-view' && $page !=='layout-full-width' && $page !=='layout-rtl') { ?>
                ...
                <div class="dropdown me-3">
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <div class="p-2 rounded-bottom border-top text-center">
                            <a href="notifications" class="text-center text-decoration-underline fs-14 mb-0">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="doctors-appointments" class="btn topbar-link"><i class="ti ti-calendar-due"></i></a>
                </div>
            </div>                    

            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="doctors-profile-settings" class="btn topbar-link"><i class="ti ti-settings-2"></i></a>
                </div> 
            </div>                    
            ...
            <div class="header-item">
                <div class="dropdown me-3">
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <!-- View All-->
                        <div class="p-2 rounded-bottom border-top text-center">
                            <a href="doctors-notifications" class="text-center text-decoration-underline fs-14 mb-0">
                                View All Notifications
                            </a>
                        </div> 
            ...
            <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                    ...
                    <!-- Item-->
                    <a href="doctors-profile-settings" class="dropdown-item">
                        <i class="ti ti-user-circle me-1 align-middle"></i>
                        <span class="align-middle">Profile Settings</span>
                    </a>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="patient-appointments" class="btn topbar-link"><i class="ti ti-calendar-due"></i></a>
                </div>
            </div>                    

            <div class="header-item">
                <div class="dropdown me-2">
                    <a href="patient-profile-settings" class="btn topbar-link"><i class="ti ti-settings-2"></i></a>
                </div> 
            </div>                    
            ...
            <div class="header-item">
                <div class="dropdown me-3">
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <!-- View All-->
                        <div class="p-2 rounded-bottom border-top text-center">
                            <a href="patient-notifications" class="text-center text-decoration-underline fs-14 mb-0">
                                View All Notifications
                            </a>
                        </div>
            ...
            <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                    ...
                    <!-- Item-->
                    <a href="patient-profile-settings" class="dropdown-item">
                        <i class="ti ti-user-circle me-1 align-middle"></i>
                        <span class="align-middle">Profile Settings</span>
                    </a>
