        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
                ...
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <a href="new-appointment" class="btn btn-primary d-inline-flex align-items-center"><i class="ti ti-plus me-1"></i>New Appointment</a>
                    <a href="doctor-schedule" class="btn btn-outline-white bg-white d-inline-flex align-items-center"><i class="ti ti-calendar-time me-1"></i>Schedule Availability</a>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="./assets/img/bg/bg-01.svg" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="./assets/img/bg/bg-02.svg" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="./assets/img/bg/bg-03.svg" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="./assets/img/bg/bg-04.svg" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                                ...
                                <div class="col-md-4">
                                    <div class="border shadow-sm p-3 rounded-2">
                                        <div class="d-flex align-items-center mb-3">
                                            <a href="doctor-details" class="avatar me-2 flex-shrink-0 position-relative">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. Alex Morgan</a></h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 bg-light p-3 rounded-2 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="mb-0 text-truncate"><i class="ti ti-calendar-time me-1 text-dark"></i> Wed, 05 Apr 2025, 06:30 PM  </p>
                                </div>
                            ...
                            <a href="appointments" class="btn btn-light w-100">View All Appointments</a>
                        </div>
                    </div>
                </div>
                    <!-- col end -->
