            ...
            <div class="table-responsive">
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details">#PRE0025</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td class="action-item">
                                ...
                                <ul class="dropdown-menu p-2">
                                    <li>
                                        <a href="doctors-prescription-details" class="dropdown-item d-flex align-items-center">View</a>
                                    </li>
                                    <li>
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0024</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0023</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0022</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0021</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0020 </a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0019</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0018</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0017</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
                        ...
                        <tr>
                            <td>
                                <a href="doctors-prescription-details"> #PRE0016</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm me-2">
