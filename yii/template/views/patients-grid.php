            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-4">
                ...
                <div class="text-end d-flex">
                    ...
                    <div class="bg-white border shadow-sm rounded px-1 pb-0 text-center d-flex align-items-center justify-content-center">
                        <a href="patients" class="bg-white rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-list fs-14 text-dark"></i></a>
                        <a href="patients-grid" class="bg-light rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-layout-grid fs-14 text-body"></i> </a>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="patient-details" class="avatar avatar-lg me-2">
                                ...
                                <ul class="dropdown-menu p-2">
                                    ...
                                    <li>
                                        <a href="appointments" class="dropdown-item d-flex align-items-center">Appointment</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Martin Lisa <span class="text-body fs-13 fw-normal d-block"> 26, Female </span></a>
                                </div>
                                <a href="javascript:void(0);" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1" data-bs-toggle="dropdown">
                                    <i class="ti ti-dots-vertical"></i>
                                </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Ava Mitchell <span class="text-body fs-13 fw-normal d-block"> 25, Female </span></a>
                                </div>
                                <a href="javascript:void(0);" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1" data-bs-toggle="dropdown">
                                    <i class="ti ti-dots-vertical"></i>
                                </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Noah Davis <span class="text-body fs-13 fw-normal d-block"> 32, Male </span></a>
                                </div>
                                <a href="javascript:void(0);" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1" data-bs-toggle="dropdown">
                                    <i class="ti ti-dots-vertical"></i>
                                </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Emily Ross <span class="text-body fs-13 fw-normal d-block"> 29, Female </span></a>
                                </div>
                                <a href="javascript:void(0);" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1" data-bs-toggle="dropdown">
                                    <i class="ti ti-dots-vertical"></i>
                                </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="patient-details" class="text-dark fw-semibold">Ryan Anderson <span class="text-body fs-13 fw-normal d-block"> 30, Male </span></a>
                                </div>
                                <a href="javascript:void(0);" class="shadow-sm fs-14 d-inline-flex border rounded-2 p-1" data-bs-toggle="dropdown">
                                    <i class="ti ti-dots-vertical"></i>
                                </a>
