        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="card shadow-sm flex-fill w-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="doctor-schedule" class="btn fw-normal btn-outline-white">View All</a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="overflow-auto">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="doctor-details" class="avatar flex-shrink-0">
                                        <img src="assets/img/doctors/doctor-02.jpg" class="rounded-circle" alt="img">
                                    </a>
                                    <div class="ms-2 flex-shrink-0">
                                        <div>
                                            <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="doctor-details">Dr. Sarah Johnson</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2 flex-shrink-0">
                                        <div>
                                            <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="doctor-details">Dr. Emily Carter</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2 flex-shrink-0">
                                        <div>
                                            <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="doctor-details">Dr. David Lee</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2 flex-shrink-0">
                                        <div>
                                            <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="doctor-details">Dr. Michael Smith</a></h6>
                ...
                <div class="col-12 d-flex">
                    <div class="card shadow-sm flex-fill w-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="appointments" class="btn fw-normal btn-outline-white">View All</a>
                        </div>
                        <div class="card-body">
                            <!-- Table start -->
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. John Smith</a></h6>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="patient-details" class="avatar me-2">
                                                        <img src="assets/img/profiles/avatar-02.jpg" alt="img" class="rounded-circle">
                                                    </a>
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Jesus Adams</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Lisa White</a></h6>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Ezra Belcher</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Patricia Brown</a></h6>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Glen Lentz</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Rachel Green</a></h6>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Bernard Griffith</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Michael Smith</a></h6>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">John Elsass</a></h6>
                ...
                <div class="col-xl-4 d-flex">
                    <div class="card shadow-sm flex-fill w-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="patients" class="btn fw-normal btn-outline-white">View All</a>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="patient-details" class="avatar me-2 flex-shrink-0">
                                        <img src="assets/img/profiles/avatar-02.jpg" alt="img" class="rounded-circle">
                                    </a>
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Jesus Adams</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Ezra Belcher</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Glen Lentz</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Bernard Griffith</a></h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">John Elsass</a></h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div>
                                            <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="doctor-details">James Allaire</a></h6>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div>
                                            <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="doctor-details">Esther Schmidt</a></h6>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div>
                                            <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="doctor-details">Valerie Padgett</a></h6>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div>
                                            <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="doctor-details">Diane Nash</a></h6>
                            ...
                            <div class="d-flex justify-content-between mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div>
                                            <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="doctor-details">Sally Cavazos</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Alberto Ripley</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Susan Babin</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Carol Lam</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fs-14 mb-1"><a href="patient-details" class="fw-medium">Marsha Noland</a></h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Alberto Ripley</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Susan Babin</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Carol Lam</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Marsha Noland</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="patient-details" class="fw-medium">Irma Armstrong</a></h6>
                ...
                <div class="col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow-sm flex-fill w-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="doctor-details" class="avatar me-2 flex-shrink-0">
                                        <img src="assets/img/doctors/doctor-01.jpg" alt="img" class="rounded-circle">
                                    </a>
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. Mick Thompson</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. Sarah Johnson</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. Emily Carter</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. David Lee</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 mb-1 text-truncate"><a href="doctor-details" class="fw-semibold">Dr. Anna Kim</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Mick Thompson</a></h6>
                                                <p class="mb-0 fs-13">Cardiologist</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Sarah Johnson</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Emily Carter</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. David Lee</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1"><a href="doctor-details" class="fw-semibold">Dr. Anna Kim</a></h6>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="card">
                        <div class="card-body d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
                            <div class="me-3 doctor-profile-img"><a href="doctor-details"><img src="assets/img/doctors/doctor-01.jpg" class="rounded" alt=""></a></div>
                            <div class="flex-fill">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h6 class="mb-0 fs-14 fw-semibold text-truncate"><a href="doctor-details">Dr. Mick Thompson</a></h6>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card">
                        <div class="card-body d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
                            <div class="me-3 doctor-profile-img"><a href="doctor-details"><img src="assets/img/doctors/doctor-02.jpg" class="rounded" alt=""></a></div>
                            <div class="flex-fill">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h6 class="mb-0 fs-14 fw-semibold text-truncate"><a href="doctor-details">Dr. Sarah Johnson</a></h6>
                                    <div class="action-item">
                                        <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                            <i class="ti ti-dots-vertical"></i>
                                        </a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card">
                        <div class="card-body d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
                            <div class="me-3 doctor-profile-img"><a href="doctor-details"><img src="assets/img/doctors/doctor-03.jpg" class="rounded" alt=""></a></div>
                            <div class="flex-fill">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h6 class="mb-0 fs-14 fw-semibold text-truncate"><a href="doctor-details">Dr. Emily Carter</a></h6>
                                    <div class="action-item">
                                        <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                            <i class="ti ti-dots-vertical"></i>
                                        </a>
            ...
            <div class="row">
                    ...
                    <div class="card blog-item">
                        <div class="card-body p-0">
                            <div class="position-relative rounded-top overflow-hidden">
                                <a href="blog-details" class="blog-img"><img src="assets/img/blogs/blog-img-01.jpg" alt="img" class="img-fluid rounded-top"></a>
                                ...
                                <a href="edit-blog" class="btn btn-sm fs-16 d-inline-flex align-items-center justify-content-center p-2 bg-white rounded-2 blog-edit"><i class="ti ti-edit"></i></a>
                            </div>
                            <div class="p-3">
                                <span class="badge badge-soft-primary border border-primary fw-medium fs-13 py-1 px-2 mb-3">Preventive Care</span>
                                <h6 class="fw-bold"><a href="blog-details">Health First: Your Guide to Better Living</a></h6>
                ...
                <div class="col-md-4">
                    <div class="card blog-item">
                        <div class="card-body p-0">
                            <div class="position-relative rounded-top overflow-hidden">
                                <a href="blog-details" class="blog-img"><img src="assets/img/blogs/blog-img-02.jpg" alt="img" class="img-fluid rounded-top"></a>
                            ...
                            <div class="p-3">
                                ...
                                <h6 class="fw-bold"><a href="blog-details">Balance Your Plate, Boost Your Life</a></h6>
                ...
                <div class="col-md-4">
                    <div class="card blog-item">
                        <div class="card-body p-0">
                            <div class="position-relative rounded-top overflow-hidden">
                                <a href="blog-details" class="blog-img"><img src="assets/img/blogs/blog-img-04.jpg" alt="img" class="img-fluid rounded-top"></a>
                                <a href="javascript:void(0);" class="btn btn-sm fs-16 d-inline-flex align-items-center justify-content-center p-2 bg-white rounded-2 blog-delete"><i class="ti ti-trash"></i></a>
                                <a href="edit-blog" class="btn btn-sm fs-16 d-inline-flex align-items-center justify-content-center p-2 bg-white rounded-2 blog-edit"><i class="ti ti-edit"></i></a>
                            </div>
                            <div class="p-3">
                                <span class="badge badge-soft-primary fw-medium border border-primary fs-13 py-1 px-2 mb-3">Health Tips</span>
                                <h6 class="fw-bold"><a href="blog-details">Small Daily Habits, Big Health Benefits</a></h6>
