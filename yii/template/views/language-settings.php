                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="language-settings2" class=" me-2 flex-shrink-0"><img src="assets/img/flags/us.svg" alt="img" class="avatar avatar-xs rounded-circle"></a>
                                                        <a href="language-settings2">English</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    en
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="language-settings2" class="btn btn-sm btn-outline-white me-2">Web</a>
                                                        <a href="language-settings2" class="btn btn-sm btn-outline-white me-2">App</a>
                                                        <a href="language-settings2" class="btn btn-sm btn-outline-white">Admin</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="language-settings2" class="flex-shrink-0 me-2"><img src="assets/img/flags/de.svg" alt="img" class="avatar avatar-xs rounded-circle"></a>
                                                        <a href="language-settings2">German</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    de
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="language-settings2" class="flex-shrink-0 me-2"><img src="assets/img/flags/ae.svg" alt="img" class="avatar avatar-xs rounded-circle"></a>
                                                        <a href="language-settings2">Arabic</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    ar
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="language-settings2" class="flex-shrink-0 me-2"><img src="assets/img/flags/fr.svg" alt="img" class="avatar avatar-xs rounded-circle"></a>
                                                        <a href="language-settings2">French</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    fr
