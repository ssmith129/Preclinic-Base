            ...
            events: [
                {
                    ...
                    extendedProps: {
                        avatars: [
                            'build/img/users/user-01.jpg',
                            'build/img/users/user-02.jpg',
                            'build/img/users/user-03.jpg',
                        ]
                    }
                ...
                },
                {
                    ...
                    extendedProps: {
                        avatars: [
                            'build/img/users/user-04.jpg',
                            'build/img/users/user-05.jpg',
                            'build/img/users/user-06.jpg',
                        ]
                    }
                },
                {
                    ...
                    extendedProps: {
                        avatars: [
                            'build/img/users/user-07.jpg',
                            'build/img/users/user-08.jpg',
                            'build/img/users/user-09.jpg',
                        ]
                    }
                },
                {
                    ...
                    extendedProps: {
                        avatars: [
                            'build/img/users/user-10.jpg',
                            'build/img/users/user-11.jpg',
                        ]
                    }
                },
                {
                    ...
                    extendedProps: {
                        avatars: [
                            'build/img/users/user-12.jpg',
                            'build/img/users/user-13.jpg',
                        ]
                    }
                },
                {
