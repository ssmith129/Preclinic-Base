...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <!-- page header start -->
            <div class="mb-4">
                <h6 class="fw-bold mb-0 d-flex align-items-center"> <a href="{{url('patients')}}" class="text-dark"> <i class="ti ti-chevron-left me-1"></i>Patients</a></h6>
            </div>
            <!-- page header end -->
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="p-3 text-lg-end">
                            ...
                            <a href="{{url('new-appointment')}}" class="btn btn-primary"><i class="ti ti-calendar-event me-1"></i>Book Apppointment</a>
                        </div>
                    </div>
                    </div>
            </div>
