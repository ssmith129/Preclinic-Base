        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
                <div class="flex-grow-1">
                    <h4 class="fw-bold mb-0">Scrollbar</h4>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <p class="text-muted m-3">Just use data attribute <code>data-simplebar</code> and add <code>max-height: **px</code> oh fix height</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p class="text-muted">Just use data attribute <code>data-simplebar data-simplebar-direction='rtl'</code> and add <code>max-height: **px</code> oh fix height</p>
                        </div> <!-- end card-body -->
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p class="text-muted">Just use data attribute <code>data-simplebar</code> and add <code>max-height: **px</code> oh fix height</p>
                        </div> <!-- end card-body -->
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p class="text-muted">Just use data attribute <code>data-simplebar data-simplebar-primary</code> and add <code>max-height: **px</code> oh fix height </p>
                        </div> <!-- end card-body -->
