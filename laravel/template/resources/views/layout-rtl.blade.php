        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
                ...
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <a href="{{url('new-appointment')}}" class="btn btn-primary d-inline-flex align-items-center"><i class="ti ti-plus me-1"></i>New Appointment</a>
                    <a href="{{url('doctor-schedule')}}" class="btn btn-outline-white bg-white d-inline-flex align-items-center"><i class="ti ti-calendar-time me-1"></i>Schedule Availability</a>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="{{URL::asset('./build/img/bg/bg-01.svg')}}" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="{{URL::asset('./build/img/bg/bg-02.svg')}}" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="{{URL::asset('./build/img/bg/bg-03.svg')}}" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="position-relative border card rounded-2 shadow-sm">
                        <img src="{{URL::asset('./build/img/bg/bg-04.svg')}}" alt="img" class="position-absolute end-0 top-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 justify-content-between">
                                ...
                                <div class="col-md-4">
                                    <div class="border shadow-sm p-3 rounded-2">
                                        <div class="d-flex align-items-center mb-3">
                                            <a href="{{url('doctor-details')}}" class="avatar me-2 flex-shrink-0 position-relative">
                                            ...
                                            <div>
                                                <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('doctor-details')}}" class="fw-semibold">Dr. Alex Morgan</a></h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 bg-light p-3 rounded-2 d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-list-stacked avatar-group-sm event flex-shrink-0"> 
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/profiles/avatar-26.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/doctors/doctor-05.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                </div>
                            </div>
                            <div class="mb-3 bg-soft-danger p-3 rounded-2 d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-list-stacked avatar-group-sm event flex-shrink-0"> 
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/users/user-17.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/doctors/doctor-10.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                </div>
                            </div>
                            <div class="mb-3 bg-soft-info p-3 rounded-2 d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-list-stacked avatar-group-sm event flex-shrink-0"> 
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/users/user-16.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                    <span class="avatar avatar-lg rounded-circle border-0"><img src="{{URL::asset('build/img/doctors/doctor-09.jpg')}}" class="img-fluid rounded-circle border border-white" alt="Img"></span>
                                </div>
                            </div>
                            <a href="{{url('appointments')}}" class="btn btn-light w-100">View All Appointments</a>
                        </div>
                    </div>
                </div>
                    <!-- col end -->
