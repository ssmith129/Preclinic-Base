<?php $page = 'forgot-password-cover'; ?>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row justify-content-center align-items-center overflow-auto flex-wrap vh-100">
                        <div class="col-md-8 mx-auto">
                            <form action="{{url('email-verification-cover')}}" class="d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <h6 class="fw-normal fs-14 text-dark mb-0">Return to
                                                    <a href="{{url('login-cover')}}" class="hover-a"> login</a>
                                                </h6>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
