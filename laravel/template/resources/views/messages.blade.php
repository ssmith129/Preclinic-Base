                            ...
                            <div class="sidebar-body chat-body" id="chatsidebar">
                                ...
                                <div class="chat-users-wrap">
                                    ...
                                    <div class="chat-list">
                                        <a href="{[url('chat')}}" class="chat-user-list">
                                            <div class="avatar avatar-lg online me-2">
                                                <img src="{{URL::asset('build/img/profiles/avatar-18.jpg')}}" class="rounded-circle" alt="image">
                                            </div>
                                            <div class="chat-user-info">
                                                <div class="chat-user-msg">
                                                    <h6>Rebecca Smtih</h6>
                                    ...
                                    <div class="chat-list">
                                        <a href="{[url('chat')}}" class="chat-user-list">
                                            <div class="avatar avatar-lg online me-2">
                                                <img src="{{URL::asset('build/img/profiles/avatar-15.jpg')}}" class="rounded-circle" alt="image">
                                            </div>
                                            <div class="chat-user-info">
                                                <div class="chat-user-msg">
                                    ...
                                    <div class="chat-list">
                                        <a href="{[url('chat')}}" class="chat-user-list mb-0">
                                            <div class="avatar avatar-lg online me-2">
                        ...
                        <div class="chat-body chat-page-group slimscroll">
                            <div class="messages">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li class="emoj-action"><a href="javascript:void(0);"><i class="ti ti-mood-smile"></i></a>
                                                            <div class="emoj-group-list">
                                                                <ul>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-02.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-05.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-06.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-07.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-08.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-03.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-10.svg')}}" alt="Icon"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/emojis/emoji-09.svg')}}" alt="Icon"></a>
                                                                    </li>
                                ...
                                <div class="chats chats-right">
                                    ...
                                    <div class="chat-avatar">
                                        <img src="{{URL::asset('build/img/profiles/avatar-14.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                    </div>
                                </div>
                                <div class="chats">
                                    <div class="chat-avatar">
