<?php $page = 'database-backup-settings'; ?>
                        ...
                        <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
                            <div class="card-header border-bottom px-0 mx-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#generate"><i class="ti ti-plus me-1"></i>Generate Backup</a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-item">
                                                    ...
                                                    <ul class="dropdown-menu p-2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_backup">Delete</a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
