<?php $page = 'reset-password-illustration'; ?>
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="login-backgrounds d-lg-flex align-items-center justify-content-center d-none flex-wrap p-4 position-relative h-100 z-0">
                        <img src="{{URL::asset('build/img/auth/reset-illustration-img.png')}}" alt="log-illustration-img-01" class="img-fluid img1">
                    </div>
                </div> <!-- end row-->
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row justify-content-center align-items-center overflow-auto flex-wrap vh-100 py-3">
                        <div class="col-md-8 mx-auto">
                            <form action="{{url('success-illustration')}}" class="d-flex justify-content-center align-items-center">
