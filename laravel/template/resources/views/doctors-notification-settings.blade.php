<?php $page = 'doctors-notification-settings'; ?>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="text-start">
                                <a href="{{url('doctors-profile-settings')}}" class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i class="ti ti-user-cog me-2 text-dark"> </i>Profile Settings  </a>
                                <a href="{{url('doctors-password-settings')}}" class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i class="ti ti-lock-star me-2 text-dark"> </i> Change Password </a>
                                <a href="{{url('doctors-notification-settings')}}" class="d-block w-100 btn btn-md border rounded fs-14 fw-medium text-primary text-start mb-1 "> <i class="ti ti-bell me-2 text-primary active"> </i>Notifications </a>
                            </div>
