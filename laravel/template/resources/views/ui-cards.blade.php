                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4">
                                <img src="{{URL::asset('build/img/media/img-6.jpg')}}" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Card title</h5>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-md-4">
                                <img src="{{URL::asset('build/img/media/img-7.jpg')}}" class="img-fluid rounded-end" alt="...">
                            </div> <!-- end col -->
                        </div> <!-- end row -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
