                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3 d-flex align-items-center">
                                            ...
                                            <div class="drag-upload-btn avatar avatar-xxl rounded-circle bg-light text-muted position-relative overflow-hidden z-1 mb-2 ms-4 p-0">
                                                <img src="{{URL::asset('./build/img/users/user-08.jpg')}}" alt="img" class="position-relative z-n1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-icon-end position-relative">  
                                                <input type="text" class="form-control datetimepicker" placeholder="dd/mm/yyyy" value="15-01-1999">
