<?php $page = 'patient-invoice-details'; ?>
                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column mb-4">
                        <div class="flex-grow-1">
                            <h6 class="fs-14 fw-semibold mb-0 d-flex align-items-center "> <a href="{{url('patient-invoices')}}" class="me-1"><i class="ti ti-chevron-left"></i> Patient Invoices</a></h6>
                        </div>
                    </div>
                    <!-- end page header -->
                                ...
                                <div class="col-lg-6">
                                    <div class="">
                                        ...
                                        <div>
                                            ...
                                            <p class="fw-semibold text-dark">Dollar One thousand nine hundred seventy-two</p>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            </div>
