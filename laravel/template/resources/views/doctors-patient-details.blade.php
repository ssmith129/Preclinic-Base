<?php $page = 'doctors-patient-details'; ?>
                ...
                <div class="row align-items-end">
                    <div class="col-xl-9 col-lg-8">
                        <div class="d-sm-flex align-items-center position-relative z-0 overflow-hidden p-3">
                            <img src="{{URL::asset('./build/img/icons/shape-01.svg')}}" alt="img" class="z-n1 position-absolute end-0 top-0 d-none d-lg-flex">
                            <a href="javascript:void(0);" class="avatar avatar-xxxl patient-avatar me-2 flex-shrink-0">
                                <img src="{{URL::asset('build/img/users/user-08.jpg')}}" alt="product" class="rounded">
                            </a>
                            <div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="p-3 text-lg-end">
                            ...
                            <a href="{{url('doctors-appointment-details')}}" class="btn btn-primary"><i class="ti ti-calendar-event me-1"></i>Book Apppointment</a>
                        </div>
                    </div>
                    </div>
            </div>
                        ...
                        <table class="table datatable table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-doctors')}}" class="avatar me-2 flex-shrink-0">
                                                <img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}" alt="img" class="rounded-circle">
                                            </a>
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Mick Thompson</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Sarah Johnson</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Emily Carter</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. David Lee</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Anna Kim</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. John Smith</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Lisa White</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Patricia Brown</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Rachel Green</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                            <h6 class="fs-14 mb-1 text-truncate"><a href="{{url('patient-doctors')}}" class="fw-semibold">Dr. Michael Smith</a></h6>
                                            <p class="mb-0 fs-13 text-truncate">Cardiologist</p>
                                            </div>
                                        </div>
                                    </td>
