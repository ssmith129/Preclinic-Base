<?php $page = 'sms-templates-settings'; ?>
                        ...
                        <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
                            <div class="card-header border-bottom px-0 mx-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_template"><i class="ti ti-plus me-1"></i>New Template</a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-item">
                                                    ...
                                                    <ul class="dropdown-menu p-2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">Clone</a>
                                                        </li>
                                                        <li>
