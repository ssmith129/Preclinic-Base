...
@Component({
  ...
  imports: [CommonModule,MatSelectModule,BsDatepickerModule,CustomPaginationComponent,MatSortModule,FilterComponent,FormsModule]
})
...
constructor(
  ...
  this.data.getStaffs().subscribe((apiRes: apiResultFormat) => {
    this.actualData = apiRes.data;
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.staffs) {
