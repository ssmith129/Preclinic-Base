...
import { apiResultFormat, deleteAccount, pageSelection } from '../../../../../../src/app/shared/models/models';
...
@Component({
  ...
  imports:[CommonModule,RouterLink,MatSelectModule,BsDatepickerModule,CustomPaginationComponent,MatSortModule,FormsModule,MultiSelectModule]
})
export class DeleteAccountRequestComponent {
routes=routes
public pageSize = 10;
public tableData: deleteAccount[] = [];
public tableDataCopy: deleteAccount[] = [];
public actualData: deleteAccount[] = [];
